...
public class NotificationPacketListener implements PacketListener
{
	...
	public void processPacket(Packet packet)
	{
		...
		if (packet instanceof Message)
		{
			...
			intent.putExtra(Constants.NOTIFICATION_API_KEY, notification.getProperty("productName") == null ? null
					: String.valueOf(notification.getProperty("productName")));
			intent.putExtra(Constants.NOTIFICATION_TITLE, notification.getSubject());
			intent.putExtra(Constants.NOTIFICATION_MESSAGE, notification.getBody());

...
/**********************************************************
 * @文件名称：RejectedFragment.java
 * @文件作者：xiongjiangwei
 * @创建时间：2015年3月24日 下午3:11:03
 * @文件描述：reedit,stopped状态的RFQ列表Fragment
 * @修改历史：2015年3月24日创建初始版本
 **********************************************************/
@EFragment(R.layout.rfq_list)
public class RejectedFragment extends RFQBaseFragment
{
	protected String TAG = "RejectedFragment";
